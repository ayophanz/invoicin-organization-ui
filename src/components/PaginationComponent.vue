<template>
  <SlideInComponent
    :class="props.loading ? 'visible' : 'invisible'"
  ></SlideInComponent>
  <nav
  ...
  >
    <div class="-mt-px flex w-0 flex-1">
      <a
        ...
        class="inline-flex items-center border-t-2 border-transparent pr-1 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-slate-700"
      >
    ...
    <div class="-mt-px flex w-0 flex-1 justify-end">
      <a
        ...
        "
        class="inline-flex items-center border-t-2 border-transparent pl-1 pt-4 text-sm font-medium text-gray-500 hover:border-slate-300 hover:text-slate-700"
      >
        Next
